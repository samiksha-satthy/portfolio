...
function Experience(props) {
  return (
    <div className="mx-10 sm:w-full md:w-full flex md:flex-row flex-col items-center lg:px-2 pt-2 md:mx-15 lg:mx-20 group lg:w-2/3 bg-card rounded-xl overflow-hidden shadow-md bg-[#1d1836]/90 backdrop-blur-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:border-[#8c52ff] border border-white/10">
            ...
            <div className="flex flex-col gap-3 p-4">
                ...
                <ul className="list-disc pl-6">
                    {props.points.map(point => {
                        return (<li className="text-white">{point}</li>)
                    })}
                </ul>
            </div> 
    </div>
...
function Experiences() {
  ...
  return (
    <div className="flex flex-col gap-10 items-center h-auto py-30 mx-6">
